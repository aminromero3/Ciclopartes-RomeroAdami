        ...
        return (
            ...
            <div className="collapse navbar-collapse" id="navbarNavDropdown">
                <ul className="navbar-nav nav me-auto mb-2 mb-md-0 ">
                    ...
                    <li className="nav-item"><Link to="/categoria/ruta" className="nav-link px-2 link-dark">Bicletas de ruta</Link></li>
                    <li className="nav-item"><Link to="/categoria/paseo" className="nav-link px-2 link-dark">Bicletas de paseo</Link></li>
